...
-->
          ...
          <div class="tile_count">
            <div class="col-md-2 col-sm-4  tile_stats_count">
              ...
              <div class="count">{{$AllPosts + $InactivePosts}}</div>
            </div>
            <div class="col-md-2 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Active Jobs</span>
              <div class="count">{{$ActivePosts}}</div>
            </div>
            <div class="col-md-2 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Inactive Jobs</span>
              <div class="count">{{$InactivePosts}}</div>
            </div>
            <div class="col-md-2 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Closed Jobs</span>
              <div class="count">{{$closedPosts}}</div>
            </div>
            <div class="col-md-3 col-sm-5  tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> candidates confirmed</span>
              <div class="count">{{$closedjobsCandidates}}</div>
            </div>
            <!-- <div class="col-md-2 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> job Applications</span>
              <div class="count">{{$closedPosts}}</div>
            </div> -->

            <div class="col-md-2 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-clock-o"></i>Total Applied</span>
            ...
            <div class="col-md-3 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-clock-o"></i>Total Candidates</span>
              <div class="count">{{$CandidatesCount}}</div>
              <!--<span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>3% </i> From last Week</span>-->
            </div>
            <div class="col-md-3 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Active Candidates</span>
              <div class="count green">{{$activeCandidates}}</div>
              <!--<span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>34% </i> From last Week</span>-->
            </div>
            <div class="col-md-3 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i>  InActive Candidates</span>
              <div class="count">{{$inactiveCandidates}}</div>
              <!--<span class="count_bottom"><i class="red"><i class="fa fa-sort-desc"></i>12% </i> From last Week</span>-->
            </div>
            <div class="col-md-3 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Closed Candidates</span>
              <div class="count">{{$closedCandidates}}</div>
              <!--<span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>34% </i> From last Week</span>-->
            </div>
            <!--<div class="col-md-2 col-sm-4  tile_stats_count">-->
                      ...
                      <div>
                        <div class="x_title">
                          ...
                          <ul class="list-unstyled top_profiles scroll-view">
                              @foreach($lastFiveCandidates as $cand)
                            ...
                            <li class="media event">
                              ...
                              <div class="media-body">
                                <a class="title" href="#">{{$cand->firstname . $cand->lastname }}</a>
                                <p><strong>{{$cand->email }}. </strong></p>
                                <p> <small>{{$cand->contactnumber }}</small>
                                <p> <small>Experience : {{$cand->experience }}</small>
                                </p>
                              </div>
                            </li>
                        @endforeach

                  ...
                  <div class="col-lg-12">
                    <div class="p-5">
                      <div class="text-center">
                        <h1 class="h4 text-gray-900 mb-4">Add Candidate</h1>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="contactemail" id="contactemail" placeholder="Enter Contact Email">
                      </div>
                      ...
                      <div class="form-group">
                        <label for="authorization">Work Authorization <span style="color:red">*</span></label>
                          ...
                          @foreach($workAuthorizations as $workAuthorization)
                            <option value="{{$workAuthorization->id}}">{{$workAuthorization->type}}</option>
                          @endforeach
                          </select>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="row">
                          <div class="col-md-6">
                            ...
                            <div class="d-flex">
                              ...
                              <input type="text" class="form-control" id="expectedrate" name="expectedrate" placeholder="Expected Rate">
                            </div>
                          </div>
                          <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <label for="employee">Employee Type <span style="color:red">*</span></label>
                          ...
                          @foreach($employetypes as $employetype)
                            <option value="{{$employetype->id}}">{{$employetype->type}}</option>
                          @endforeach
                          </select>
                      </div>
                      <div class="form-group">
                  ...
                  <button type="button" class="btn btn-primary" style="margin-top:3px" onclick="add_field();"> + Skills </button>
                    ...
                    <br>
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="education" name="education" placeholder="Highest Education:">
                      </div>
                      <div class="form-group">
                        <label for="linked">Linked</label>
                        <input type="text" class="form-control" id="linked" name="linked" placeholder="Linked">
                      </div>
                      <div class="form-group">
                        <label for="availabledate">Available Date</label>
                        <input type="date" class="form-control" id="avaliabledate" name="avaliabledate" placeholder="Available Date">
                      </div>
                      <br>
                      <br>
                      <input onclick="AddCandidate()" style="background-color: #f23022;" type="submit" name="submit" value="Create" class="btn btn-primary btn-user btn-block col-md-3">
                      <hr>
                    </div>
                  </div>
                </div>
  ...
  $.ajax({
    ...
    success: function(result)
    {
      if(result.status == 1 && result.success == true)
      {
         ...
         linked = $('#linked').val('')
         avaliabledate = $('#avaliabledate').val('')
        swal({
              title: "Candidate Added Sucessully",
              text: "Success",
              icon: "success",
              button: "Ok",
              timer: 4000

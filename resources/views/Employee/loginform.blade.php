                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 style="color: #f23022;" class="h4 mb-4">Employee Login</h1>
                            </div>
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="col-md-5">
                                <a style="background-color: #f23022;" href="{{route('EmployeeRegister')}}" class="btn btn-primary btn-user btn-block">
                                Sign up 
                                </a>
                            </div></div> 
                               </form>
                            <hr>
                            <div class="text-center">
                                <a style="color: #f23022;" class="small" href="#">Forgot Password?</a>
                            </div>

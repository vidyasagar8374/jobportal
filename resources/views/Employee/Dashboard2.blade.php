         ...
         <div class="container">
            ...
            <div class="row m-0">
               <form method="post" action="{{url('jobapply')}}">
                ...
                @include('Employee/paginatedashboardapply')

                <div class="modal fade" id="candidatelist" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Candidates List</h5>
      ...
      <div class="modal-body">
        <div>
            <div style="margin-bottom:30px;margin-left:40px">
            <select class="selectpicker" multiple placeholder="select" data-live-search="true" name="candidates[]" id="selectedcandidateslist">
                @foreach($candidateslist as $candidate)
                    <option value="{{$candidate->id}}">{{$candidate->firstname}}({{$candidate->email}})</option>
                @endforeach
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" onclick="removecandidates()" data-dismiss="modal">Close</button>
        <button type="button" onclick="applycandidatejobpost()" class="btn btn-primary">Apply</button>
      </div>
    </div>
  </div>
</div>
